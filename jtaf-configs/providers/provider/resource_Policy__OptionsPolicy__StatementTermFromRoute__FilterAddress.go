		...
		V_policy__statement  struct {
			...
			V_term  struct {
				...
				V_route__filter  struct {
					...
					V_request__long__lived__ack  *string  `xml:"request-long-lived-ack,omitempty"`
					...
					V_source__routing__path__template  *string  `xml:"source-routing-path-template,omitempty"`
					...
					V_ignore__service__label  *string  `xml:"ignore-service-label,omitempty"`
					...
					V_send__withdrawal__on__route__change  *string  `xml:"send-withdrawal-on-route-change,omitempty"`
...
func junosPolicy__OptionsPolicy__StatementTermFromRoute__FilterAddressCreate(d *schema.ResourceData, m interface{}) error {
	...
	V_request__long__lived__ack := d.Get("request__long__lived__ack").(string)
	...
	V_source__routing__path__template := d.Get("source__routing__path__template").(string)
	...
	V_ignore__service__label := d.Get("ignore__service__label").(string)
	...
	V_send__withdrawal__on__route__change := d.Get("send__withdrawal__on__route__change").(string)
	...
	if V_request__long__lived__ack != "" { config.Groups.V_policy__statement.V_term.V_route__filter.V_request__long__lived__ack = &V_request__long__lived__ack }
	...
	if V_source__routing__path__template != "" { config.Groups.V_policy__statement.V_term.V_route__filter.V_source__routing__path__template = &V_source__routing__path__template }
	...
	if V_ignore__service__label != "" { config.Groups.V_policy__statement.V_term.V_route__filter.V_ignore__service__label = &V_ignore__service__label }
	...
	if V_send__withdrawal__on__route__change != "" { config.Groups.V_policy__statement.V_term.V_route__filter.V_send__withdrawal__on__route__change = &V_send__withdrawal__on__route__change }
...
func junosPolicy__OptionsPolicy__StatementTermFromRoute__FilterAddressRead(d *schema.ResourceData, m interface{}) error {
	...
	if config.Groups.V_policy__statement.V_term.V_route__filter.V_request__long__lived__ack != nil { 
		d.Set("request__long__lived__ack", " ") } else { d.Set("request__long__lived__ack", "")}
	...
	if config.Groups.V_policy__statement.V_term.V_route__filter.V_source__routing__path__template != nil { 
		d.Set("source__routing__path__template", " ") } else { d.Set("source__routing__path__template", "")}
	...
	if config.Groups.V_policy__statement.V_term.V_route__filter.V_ignore__service__label != nil { 
		d.Set("ignore__service__label", " ") } else { d.Set("ignore__service__label", "")}
	...
	if config.Groups.V_policy__statement.V_term.V_route__filter.V_send__withdrawal__on__route__change != nil { 
		d.Set("send__withdrawal__on__route__change", " ") } else { d.Set("send__withdrawal__on__route__change", "")}
...
func junosPolicy__OptionsPolicy__StatementTermFromRoute__FilterAddress() *schema.Resource {
	return &schema.Resource{
        ...
        Schema: map[string]*schema.Schema{
			...
			"request__long__lived__ack": &schema.Schema{
				Type:    schema.TypeString,
				Optional: true,
				Description:    "xpath is: config.Groups.V_policy__statement.V_term.V_route__filter",
			},
			...
			"source__routing__path__template": &schema.Schema{
				Type:    schema.TypeString,
				Optional: true,
				Description:    "xpath is: config.Groups.V_policy__statement.V_term.V_route__filter",
			},
			...
			"ignore__service__label": &schema.Schema{
				Type:    schema.TypeString,
				Optional: true,
				Description:    "xpath is: config.Groups.V_policy__statement.V_term.V_route__filter",
			},
			...
			"send__withdrawal__on__route__change": &schema.Schema{
				Type:    schema.TypeString,
				Optional: true,
				Description:    "xpath is: config.Groups.V_policy__statement.V_term.V_route__filter",
			},
